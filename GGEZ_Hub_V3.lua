...
local function CreateToggle(name, key, desc, icon)
	...
	iconLabel.Text = icon
	iconLabel.TextColor3 = Config[key] and YELLOW or Color3.fromRGB(150, 150, 150)
	...
	btn.MouseButton1Click:Connect(function()
		...
		Tween(iconLabel, {TextColor3 = Config[key] and YELLOW or Color3.fromRGB(150, 150, 150)})
